...
let path = {
	...
	build: {
		folder: '../Backend/wp-content/themes/'+ projectNname +'/',
		js: '../Backend/wp-content/themes/'+ projectNname +'/js/',
		css: '../Backend/wp-content/themes/'+ projectNname +'/css/',
		img: '../Backend/wp-content/themes/'+ projectNname +'/images/',
		fonts: '../Backend/wp-content/themes/'+ projectNname +'/fonts/'
	}
};
